...
{
    public partial class ShiftViewModelOld: ObservableValidator
    {
        [ObservableProperty]
        [Required]
        private string _id;
        ...
        */
        ...
        public ShiftViewModelOld(string id, string name, DateTime startTime, DateTime endTime, byte travelTime, short maxTravelDistance, AddressViewModel startLocation, AddressViewModel endLocation, char shiftType, bool reocurring)
        {
            Id = id;
            Name = name;
            StartTime = startTime;
